function [KKx,KKy,P_i_out] = coeffinder_LD123(endd,endd_fixed,z,l_b,n_l,fi,n,do_b,gamma,Q,A_c,m_c,translation_vector,th1,f_g)%KN
if nargin < 15
    f_g = 1.0;
end
% coeffinder_LD123  Same as coeffinder but uses pycurve_LD123
%                   (extrapolated betas for L/D=1.23)
eps = endd - endd_fixed;
...
k0 = 1-sind(fi);
for i = 1:n * n_l
[KK(i)] = pycurve_LD123(fi(i), gamma, dis_toward_springs(i), z(i), do_b, l_b,n)*(l_b/n_l);
end

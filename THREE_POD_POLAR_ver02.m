...
do_b = 6.5; %bucket outer diameter (Kim: Dt=6.5m)
thickness = 0.025; %bucket thickness (Kim: 25mm prototype)
l_b = 8; %length of the bucket skirt (Kim: Lt=8.0m, L/D=1.23)
...
n_q =10;
eccentricity_base = 33.39; % load eccentricity (Kim: M/H=33.39m)
th1= 60;
th2 = 180;
th3 = 300;
Deadload=4650; %kN (Kim: 4.65 MN)
l = 15.5; % circumradius (Kim: 15.5m, CtC=26.85m)
%% %%%%%%%%%% Soil parameters %%%%%%%%%%%%
gamma = 9.65; % buoyant unit weight [kN/m3] - Kim: Yellow Sea silty sand (SM)
S_gamma = 0.5;
e_max =0;
e_min =0;
D_r = 0.827; % relative density - Kim: Dr=82.7% for SM layer
...
penetration_depths = [8, 7, 6, 5, 4];  % penetration depths to analyze (m)
...
tilt_directions_compute = 60:15:(60 + sector_angle - 15);  % 60, 75, ..., 165 (one sector starting from bucket 1)
...
%% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$  SAVE RESULTS  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %%
fprintf('\n===== Saving results to THREE_POD_POLAR_results_ver02.mat =====\n');
save('THREE_POD_POLAR_results_ver02.mat', 'M_polar', 'F_H_polar', 'Q_store', ...
...
%% $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$  WRITE CSV LUT  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %%
fprintf('\n===== Writing THREE_POD_POLAR_LUT_ver02.csv =====\n');
fid = fopen('THREE_POD_POLAR_LUT_ver02.csv', 'w');
...
title(sprintf('Polar Moment at %.1f° Rotation (Three Pod)', dd_steps(end)*180/pi), 'FontSize', 20, 'FontWeight', 'bold', 'FontName', 'Times New Roman');
...
title(sprintf('Polar Horizontal Force at %.1f° Rotation (Three Pod)', dd_steps(end)*180/pi), 'FontSize', 20, 'FontWeight', 'bold', 'FontName', 'Times New Roman');
...
title(sprintf('Moment vs Rotation at %d° Tilt Direction', tilt_directions_compute(1)), 'FontSize', 20, 'FontWeight', 'bold', 'FontName', 'Times New Roman');
...
sgtitle(sprintf('Moment vs Rotation (%d°-%d° sector)', tilt_directions_compute(1), tilt_directions_compute(end)), 'FontSize', 18, 'FontWeight', 'bold', 'FontName', 'Times New Roman');
% Add shared legend
legend_labels5 = {};
for i_dir = 1:num_dirs_compute
